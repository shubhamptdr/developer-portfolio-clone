...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      ...
      initial={{ x: 0, y: 0 }}
      whileInView={{ x: x, y: y, transition: { duraton: 1.05 } }}
      viewport={{ once: true }}
    >
      {name}
    </motion.div>
...
const Skills = () => {
  return (
    <>
      ...
      <div
        className="w-full h-screen relative flex items-center justify-center rounded-full py-5 bg-circularLight dark:bg-circularDark 
