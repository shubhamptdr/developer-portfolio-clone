...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li
      ...
      viewport={{ once: true }}
      className="relative w-full  p-4 py-6 my-4 rounded-xl flex items-center justify-between bg-light text-dark first:mt-0 border border-solid border-dark dark:bg-dark dark:border-light dark:text-light border-r-4 border-b-4 sm:flex-col "
    >
...
const FeaturesArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light border border-solid  border-dark rounded-2xl relative dark:bg-dark dark:border-light">
      ...
      <Link href={link} target="_blank" className="">
        <h2 className="text-2xl font-bold my-2 mt-4 capitalize hover:underline xs:text-lg">
          {title}
        </h2>
      </Link>
    ...
    <>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout className="pt-16">
          ...
          <h2 className="font-bold text-4xl mt-32 w-full my-16 text-center">
            All Articles
          </h2>
          <ul>
            <Article
